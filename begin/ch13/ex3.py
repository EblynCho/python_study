...
def insertData() :
    ...
    # 입력창 초기화
    edt1.delete(0, len(data1)); edt2.delete(0, len(data2))
    edt3.delete(0, len(data3)); edt4.delete(0, len(data4))
...
def selectData() :
    ...
    listData1.delete(0, listData1.size()-1); listData2.delete(0, listData2.size()-1)  # 0~5 index 값이기 때문에 -1
